...
export default function PrintablesPage() {
  ...
  const handleGenerateReport = async () => {
    ...
    try {
      ...
      const bookingsForRange = querySnapshot.docs.map(doc => doc.data() as Booking);
      ...
      // Sort by start time again on the client side just in case
      bookingsForRange.sort((a, b) => new Date(a.startTime).getTime() - new Date(b.startTime).getTime());
